...
//$$     @Accessor("actions")
//$$     Map<EntityPlayerActionPack.ActionType, EntityPlayerActionPack.Action> dds$getActions();
//$$ }
//#else
import org.spongepowered.asm.mixin.Mixin;
...
@Pseudo
@Mixin(targets = "carpetddsaddition.disabled.EntityPlayerActionPackTarget")
public interface EntityPlayerActionPackAccessor {}
//#endif
