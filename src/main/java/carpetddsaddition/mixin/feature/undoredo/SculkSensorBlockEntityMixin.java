...
//$$ public abstract class SculkSensorBlockEntityMixin implements UndoOriginAccess {
...
//#else
@Pseudo
@Mixin(targets = "carpetddsaddition.disabled.UndoRedoSculkSensorBlockEntityTarget")
