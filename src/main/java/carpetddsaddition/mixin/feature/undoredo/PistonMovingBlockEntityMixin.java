...
//$$ public abstract class PistonMovingBlockEntityMixin implements UndoOriginAccess {
...
//#else
@Pseudo
@Mixin(targets = "carpetddsaddition.disabled.UndoRedoPistonMovingBlockEntityTarget")
